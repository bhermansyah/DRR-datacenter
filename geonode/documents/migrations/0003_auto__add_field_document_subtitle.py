...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.subtitle'
        db.add_column(u'documents_document', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.subtitle'
        db.delete_column(u'documents_document', 'subtitle')
