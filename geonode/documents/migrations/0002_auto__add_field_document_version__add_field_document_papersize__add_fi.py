...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'documents_document', 'version',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Document.papersize'
        db.add_column(u'documents_document', 'papersize',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Document.datasource'
        db.add_column(u'documents_document', 'datasource',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'documents_document', 'version')

        # Deleting field 'Document.papersize'
        db.delete_column(u'documents_document', 'papersize')

        # Deleting field 'Document.datasource'
        db.delete_column(u'documents_document', 'datasource')
    ...
    models = {
        ...
        u'documents.document': {
            ...
            'datasource': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'distribution_description_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'doc_file': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'papersize': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
