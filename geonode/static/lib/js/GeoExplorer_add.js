                        ...
                        '<ul>',
                            ...
                            '<li>',
                                '<div class="w3-card-4">',
                                    ...
                                    '</header>',
                                    '<div class="w3-container">',
                                        '<p><div style="float:left;">Total</div><div style="float:right;">{total_risk_mitigated_population:toMega}({percent_total_risk_population}%)</div></p><br/>',
                                        '<p><div class="lineCustom"> </div></p> <br/>',
                                        '<p><div style="float:left;">High</div><div style="float:right;">{high_risk_mitigated_population:toMega}({percent_high_risk_population}%)</div></p><br/>',
                                        '<p><div style="float:left;">Moderate</div><div style="float:right;">{med_risk_mitigated_population:toMega}({percent_med_risk_population}%)</div></p><br/>',
                                        '<p><div style="float:left;">Low</div><div style="float:right;">{low_risk_mitigated_population:toMega}({percent_low_risk_population}%)</div></p><br/>',       
                                    '</div>',
                                '</div>',
                            '</li>',
                            // '<li>',
