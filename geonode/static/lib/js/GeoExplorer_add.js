                                ...
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        '<table style="width:100%"">',
                                            '<tr><td style="padding: 5px;" align="center">'+gettext('Time')+'</td><td style="padding: 5px;" align="right">'+gettext('Population')+'</td></tr>',
                                            '<tr><td colspan="4"><div class="lineCustom4Table"></div></td></tr>',
                                            '<tr style="background:rgba(185,237,254,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 1 h')+'</td><td style="padding: 5px;" align="right">{l1_h__near_hlt1:toMega}</td></tr>',
                                            '<tr style="background:rgba(172,249,217,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 2 h')+'</td><td style="padding: 5px;" align="right">{l2_h__near_hlt1:toMega}</td></tr>',
                                            '<tr style="background:rgba(123,233,187,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 3 h')+'</td><td style="padding: 5px;" align="right">{l3_h__near_hlt1:toMega}</td></tr>',
                                            '<tr style="background:rgba(247,250,173,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 4 h')+'</td><td style="padding: 5px;" align="right">{l4_h__near_hlt1:toMega}</td></tr>',
                                            '<tr style="background:rgba(252,234,168,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 5 h')+'</td><td style="padding: 5px;" align="right">{l5_h__near_hlt1:toMega}</td></tr>',
                                            '<tr style="background:rgba(248,192,94,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 6 h')+'</td><td style="padding: 5px;" align="right">{l6_h__near_hlt1:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,153,110,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 7 h')+'</td><td style="padding: 5px;" align="right">{l7_h__near_hlt1:toMega}</td></tr>',
                                            '<tr style="background:rgba(251,86,49,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 8 h')+'</td><td style="padding: 5px;" align="right">{l8_h__near_hlt1:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,20,3,0.4)"><td style="padding: 5px;" align="left">'+gettext('> 8 h')+'</td><td style="padding: 5px;" align="right">{g8_h__near_hlt1:toMega}</td></tr>',
                                        '</table>',
                                    '</div>',
                                '</div>',
                            '</li>',
                                ...
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        '<table style="width:100%"">',
                                            '<tr><td style="padding: 5px;" align="center">'+gettext('Time')+'</td><td style="padding: 5px;" align="right">'+gettext('Population')+'</td></tr>',
                                            '<tr><td colspan="4"><div class="lineCustom4Table"></div></td></tr>',
                                            '<tr style="background:rgba(185,237,254,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 1 h')+'</td><td style="padding: 5px;" align="right">{l1_h__near_hlt2:toMega}</td></tr>',
                                            '<tr style="background:rgba(172,249,217,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 2 h')+'</td><td style="padding: 5px;" align="right">{l2_h__near_hlt2:toMega}</td></tr>',
                                            '<tr style="background:rgba(123,233,187,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 3 h')+'</td><td style="padding: 5px;" align="right">{l3_h__near_hlt2:toMega}</td></tr>',
                                            '<tr style="background:rgba(247,250,173,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 4 h')+'</td><td style="padding: 5px;" align="right">{l4_h__near_hlt2:toMega}</td></tr>',
                                            '<tr style="background:rgba(252,234,168,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 5 h')+'</td><td style="padding: 5px;" align="right">{l5_h__near_hlt2:toMega}</td></tr>',
                                            '<tr style="background:rgba(248,192,94,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 6 h')+'</td><td style="padding: 5px;" align="right">{l6_h__near_hlt2:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,153,110,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 7 h')+'</td><td style="padding: 5px;" align="right">{l7_h__near_hlt2:toMega}</td></tr>',
                                            '<tr style="background:rgba(251,86,49,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 8 h')+'</td><td style="padding: 5px;" align="right">{l8_h__near_hlt2:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,20,3,0.4)"><td style="padding: 5px;" align="left">'+gettext('> 8 h')+'</td><td style="padding: 5px;" align="right">{g8_h__near_hlt2:toMega}</td></tr>',
                                        '</table>',
                                    '</div>',
                                '</div>',
                            '</li>',
                                ...
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        '<table style="width:100%"">',
                                            '<tr><td style="padding: 5px;" align="center">'+gettext('Time')+'</td><td style="padding: 5px;" align="right">'+gettext('Population')+'</td></tr>',
                                            '<tr><td colspan="4"><div class="lineCustom4Table"></div></td></tr>',
                                            '<tr style="background:rgba(185,237,254,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 1 h')+'</td><td style="padding: 5px;" align="right">{l1_h__near_hlt3:toMega}</td></tr>',
                                            '<tr style="background:rgba(172,249,217,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 2 h')+'</td><td style="padding: 5px;" align="right">{l2_h__near_hlt3:toMega}</td></tr>',
                                            '<tr style="background:rgba(123,233,187,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 3 h')+'</td><td style="padding: 5px;" align="right">{l3_h__near_hlt3:toMega}</td></tr>',
                                            '<tr style="background:rgba(247,250,173,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 4 h')+'</td><td style="padding: 5px;" align="right">{l4_h__near_hlt3:toMega}</td></tr>',
                                            '<tr style="background:rgba(252,234,168,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 5 h')+'</td><td style="padding: 5px;" align="right">{l5_h__near_hlt3:toMega}</td></tr>',
                                            '<tr style="background:rgba(248,192,94,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 6 h')+'</td><td style="padding: 5px;" align="right">{l6_h__near_hlt3:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,153,110,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 7 h')+'</td><td style="padding: 5px;" align="right">{l7_h__near_hlt3:toMega}</td></tr>',
                                            '<tr style="background:rgba(251,86,49,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 8 h')+'</td><td style="padding: 5px;" align="right">{l8_h__near_hlt3:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,20,3,0.4)"><td style="padding: 5px;" align="left">'+gettext('> 8 h')+'</td><td style="padding: 5px;" align="right">{g8_h__near_hlt3:toMega}</td></tr>',
                                        '</table>',
                                    '</div>',
                                '</div>',
                            '</li>',
                                ...
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        '<table style="width:100%"">',
                                            '<tr><td style="padding: 5px;" align="center">'+gettext('Time')+'</td><td style="padding: 5px;" align="right">'+gettext('Population')+'</td></tr>',
                                            '<tr><td colspan="4"><div class="lineCustom4Table"></div></td></tr>',
                                            '<tr style="background:rgba(185,237,254,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 1 h')+'</td><td style="padding: 5px;" align="right">{l1_h__near_hltall:toMega}</td></tr>',
                                            '<tr style="background:rgba(172,249,217,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 2 h')+'</td><td style="padding: 5px;" align="right">{l2_h__near_hltall:toMega}</td></tr>',
                                            '<tr style="background:rgba(123,233,187,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 3 h')+'</td><td style="padding: 5px;" align="right">{l3_h__near_hltall:toMega}</td></tr>',
                                            '<tr style="background:rgba(247,250,173,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 4 h')+'</td><td style="padding: 5px;" align="right">{l4_h__near_hltall:toMega}</td></tr>',
                                            '<tr style="background:rgba(252,234,168,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 5 h')+'</td><td style="padding: 5px;" align="right">{l5_h__near_hltall:toMega}</td></tr>',
                                            '<tr style="background:rgba(248,192,94,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 6 h')+'</td><td style="padding: 5px;" align="right">{l6_h__near_hltall:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,153,110,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 7 h')+'</td><td style="padding: 5px;" align="right">{l7_h__near_hltall:toMega}</td></tr>',
                                            '<tr style="background:rgba(251,86,49,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 8 h')+'</td><td style="padding: 5px;" align="right">{l8_h__near_hltall:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,20,3,0.4)"><td style="padding: 5px;" align="left">'+gettext('> 8 h')+'</td><td style="padding: 5px;" align="right">{g8_h__near_hltall:toMega}</td></tr>',
                                        '</table>',
                                    '</div>',
                                '</div>',
                            '</li>',
                                ...
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        '<table style="width:100%"">',
                                            '<tr><td style="padding: 5px;" align="center">'+gettext('Time')+'</td><td style="padding: 5px;" align="right">'+gettext('Population')+'</td></tr>',
                                            '<tr><td colspan="4"><div class="lineCustom4Table"></div></td></tr>',
                                            '<tr style="background:rgba(185,237,254,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 1 h')+'</td><td style="padding: 5px;" align="right">{l1_h__itsx_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(172,249,217,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 2 h')+'</td><td style="padding: 5px;" align="right">{l2_h__itsx_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(123,233,187,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 3 h')+'</td><td style="padding: 5px;" align="right">{l3_h__itsx_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(247,250,173,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 4 h')+'</td><td style="padding: 5px;" align="right">{l4_h__itsx_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(252,234,168,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 5 h')+'</td><td style="padding: 5px;" align="right">{l5_h__itsx_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(248,192,94,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 6 h')+'</td><td style="padding: 5px;" align="right">{l6_h__itsx_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,153,110,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 7 h')+'</td><td style="padding: 5px;" align="right">{l7_h__itsx_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(251,86,49,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 8 h')+'</td><td style="padding: 5px;" align="right">{l8_h__itsx_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,20,3,0.4)"><td style="padding: 5px;" align="left">'+gettext('> 8 h')+'</td><td style="padding: 5px;" align="right">{g8_h__itsx_prov:toMega}</td></tr>',
                                        '</table>',
                                    '</div>',
                                '</div>',
                            '</li>',
                                ...
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        '<table style="width:100%"">',
                                            '<tr><td style="padding: 5px;" align="center">'+gettext('Time')+'</td><td style="padding: 5px;" align="right">'+gettext('Population')+'</td></tr>',
                                            '<tr><td colspan="4"><div class="lineCustom4Table"></div></td></tr>',
                                            '<tr style="background:rgba(185,237,254,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 1 h')+'</td><td style="padding: 5px;" align="right">{l1_h__near_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(172,249,217,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 2 h')+'</td><td style="padding: 5px;" align="right">{l2_h__near_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(123,233,187,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 3 h')+'</td><td style="padding: 5px;" align="right">{l3_h__near_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(247,250,173,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 4 h')+'</td><td style="padding: 5px;" align="right">{l4_h__near_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(252,234,168,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 5 h')+'</td><td style="padding: 5px;" align="right">{l5_h__near_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(248,192,94,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 6 h')+'</td><td style="padding: 5px;" align="right">{l6_h__near_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,153,110,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 7 h')+'</td><td style="padding: 5px;" align="right">{l7_h__near_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(251,86,49,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 8 h')+'</td><td style="padding: 5px;" align="right">{l8_h__near_prov:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,20,3,0.4)"><td style="padding: 5px;" align="left">'+gettext('> 8 h')+'</td><td style="padding: 5px;" align="right">{g8_h__near_prov:toMega}</td></tr>',
                                        '</table>',
                                    '</div>',
                                '</div>',
                            '</li>',
                                ...
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        '<table style="width:100%"">',
                                            '<tr><td style="padding: 5px;" align="center">'+gettext('Time')+'</td><td style="padding: 5px;" align="right">'+gettext('Population')+'</td></tr>',
                                            '<tr><td colspan="4"><div class="lineCustom4Table"></div></td></tr>',
                                            '<tr style="background:rgba(185,237,254,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 1 h')+'</td><td style="padding: 5px;" align="right">{l1_h__near_dist:toMega}</td></tr>',
                                            '<tr style="background:rgba(172,249,217,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 2 h')+'</td><td style="padding: 5px;" align="right">{l2_h__near_dist:toMega}</td></tr>',
                                            '<tr style="background:rgba(123,233,187,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 3 h')+'</td><td style="padding: 5px;" align="right">{l3_h__near_dist:toMega}</td></tr>',
                                            '<tr style="background:rgba(247,250,173,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 4 h')+'</td><td style="padding: 5px;" align="right">{l4_h__near_dist:toMega}</td></tr>',
                                            '<tr style="background:rgba(252,234,168,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 5 h')+'</td><td style="padding: 5px;" align="right">{l5_h__near_dist:toMega}</td></tr>',
                                            '<tr style="background:rgba(248,192,94,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 6 h')+'</td><td style="padding: 5px;" align="right">{l6_h__near_dist:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,153,110,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 7 h')+'</td><td style="padding: 5px;" align="right">{l7_h__near_dist:toMega}</td></tr>',
                                            '<tr style="background:rgba(251,86,49,0.4)"><td style="padding: 5px;" align="left">'+gettext('< 8 h')+'</td><td style="padding: 5px;" align="right">{l8_h__near_dist:toMega}</td></tr>',
                                            '<tr style="background:rgba(254,20,3,0.4)"><td style="padding: 5px;" align="left">'+gettext('> 8 h')+'</td><td style="padding: 5px;" align="right">{g8_h__near_dist:toMega}</td></tr>',
                                        '</table>',
                                    '</div>',
                                '</div>',
                            '</li>',
                            ...
                            '<ul>',
                                '<li>',
                                    '<div class="w3-card-4">',
                                        ...
                                        '<div class="w3-container">',
                                            '<table style="width:100%"">',
                                                '<tr><td colspan="2" align="center" style="padding: 5px;">'+gettext('Mercali Intensity Scale')+'</td><td style="padding: 5px;" align="center">'+gettext('Population')+'</td><td style="padding: 5px;" align="right">'+gettext('Settlements')+'</td></tr>',
                                                '<tr><td colspan="4"><div class="lineCustom4Table"></div></td></tr>',
                                                '<tr bgcolor="#d20003"><td style="padding: 5px;" align="left">'+gettext('X+')+'</td><td style="padding: 5px;" align="left">'+gettext('Extreme')+'</td><td style="padding: 5px;" align="center">{pop_shake_extreme:toMega}</td><td style="padding: 5px;" align="right">{settlement_shake_extreme:toMega}</td></tr>',
                                                '<tr bgcolor="#ff1f00"><td style="padding: 5px;" align="left">'+gettext('IX')+'</td><td style="padding: 5px;" align="left">'+gettext('Violent')+'</td><td style="padding: 5px;" align="center">{pop_shake_violent:toMega}</td><td style="padding: 5px;" align="right">{settlement_shake_violent:toMega}</td></tr>',
                                                '<tr bgcolor="#fd6500"><td style="padding: 5px;" align="left">'+gettext('VIII')+'</td><td style="padding: 5px;" align="left">'+gettext('Severe')+'</td><td style="padding: 5px;" align="center">{pop_shake_severe:toMega}</td><td style="padding: 5px;" align="right">{settlement_shake_severe:toMega}</td></tr>',
                                                '<tr bgcolor="#ffb700"><td style="padding: 5px;" align="left">'+gettext('VII')+'</td><td style="padding: 5px;" align="left">'+gettext('Very-Strong')+'</td><td style="padding: 5px;" align="center">{pop_shake_verystrong:toMega}</td><td style="padding: 5px;" align="right">{settlement_shake_verystrong:toMega}</td></tr>',
                                                '<tr bgcolor="#fcf109"><td style="padding: 5px;" align="left">'+gettext('VI')+'</td><td style="padding: 5px;" align="left">'+gettext('Strong')+'</td><td style="padding: 5px;" align="center">{pop_shake_strong:toMega}</td><td style="padding: 5px;" align="right">{settlement_shake_strong:toMega}</td></tr>',
                                                '<tr bgcolor="#b1ff55"><td style="padding: 5px;" align="left">'+gettext('V')+'</td><td style="padding: 5px;" align="left">'+gettext('Moderate')+'</td><td style="padding: 5px;" align="center">{pop_shake_moderate:toMega}</td><td style="padding: 5px;" align="right">{settlement_shake_moderate:toMega}</td></tr>',
                                                '<tr bgcolor="#7cfddf"><td style="padding: 5px;" align="left">'+gettext('IV')+'</td><td style="padding: 5px;" align="left">'+gettext('Light')+'</td><td style="padding: 5px;" align="center">{pop_shake_light:toMega}</td><td style="padding: 5px;" align="right">{settlement_shake_light:toMega}</td></tr>',
                                                '<tr bgcolor="#c4ceff"><td style="padding: 5px;" align="left">'+gettext('II-III')+'</td><td style="padding: 5px;" align="left">'+gettext('Weak')+'</td><td style="padding: 5px;" align="center">{pop_shake_weak:toMega}</td><td style="padding: 5px;" align="right">{settlement_shake_weak:toMega}</td></tr>',
                                            '</table>',
                                        '</div>',
                                    '</div>',
                                '</li>',
                            ...
                            '<li>',
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        ...
                                        '<p><div style="float:left;">'+gettext('Irrigated Agg land')+'</div><div style="float:right;">{irrigated_agricultural_land_pop:toMega}</div></p><br/>',
                                        '<p><div style="float:left;">'+gettext('Permanent Snow')+'</div><div style="float:right;">{permanent_snow_pop:toMega}</div></p><br/>',
                                        '<p><div style="float:left;">'+gettext('Rainfeld Agg land')+'</div><div style="float:right;">{rainfed_agricultural_land_pop:toMega}</div></p><br/>',
                            ...
                            '<li>',
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        ...
                                        '<p><div style="float:left;">'+gettext('Irrigated Agg land')+'</div><div style="float:right;">{irrigated_agricultural_land_area:toMega}</div></p><br/>',
                                        '<p><div style="float:left;">'+gettext('Permanent Snow')+'</div><div style="float:right;">{permanent_snow_area:toMega}</div></p><br/>',
                                        '<p><div style="float:left;">'+gettext('Rainfeld Agg land')+'</div><div style="float:right;">{rainfed_agricultural_land_area:toMega}</div></p><br/>',
                            ...
                            '<li>',
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        ...
                                        '<p><div style="float:left;">'+gettext('Irrigated Agg land')+'</div><div style="float:right;">{irrigated_agricultural_land_pop_risk:toMega}({precent_irrigated_agricultural_land_pop_risk}%)</div></p><br/>',
                                        ...
                                        '<p><div style="float:left;">'+gettext('Rainfeld Agg land')+'</div><div style="float:right;">{rainfed_agricultural_land_pop_risk:toMega}({precent_rainfed_agricultural_land_pop_risk}%)</div></p><br/>',
                            ...
                            '<li>',
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        ...
                                        '<p><div style="float:left;">'+gettext('Irrigated Agg land')+'</div><div style="float:right;">{irrigated_agricultural_land_area_risk:toMega}({precent_irrigated_agricultural_land_area_risk}%)</div></p><br/>',
                                        ...
                                        '<p><div style="float:left;">'+gettext('Rainfeld Agg land')+'</div><div style="float:right;">{rainfed_agricultural_land_area_risk:toMega}({precent_permanent_snow_area_risk}%)</div></p><br/>',
                ...
                config.push(Ext.apply({
                    ...
                    items:[{
                        ...
                        items:[{
                            ...
                            title: gettext('Road Accessibility'),
                            defaults: {autoScroll: true},
                            height : 500,
                            style:"height:500px;",
