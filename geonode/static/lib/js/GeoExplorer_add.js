                                ...
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        '<table style="width:100%"">',
                                            ...
                                            '<tr><td align="left"></td><td align="center">{total_flashflood_forecast_pop:toMega}</td><td align="right">{total_riverflood_forecast_pop:toMega}</td></tr>',
                            ...
                            '<li>',
                                '<div class="w3-card-4">',
                                    ...
                                    '<div class="w3-container">',
                                        '<table style="width:100%"">',
                                            '<tr><td align="left"></td><td align="center">Flash Flood</td><td align="right">River Flood</td></tr>',
                                            '<tr><td align="left"></td><td align="center">{total_flashflood_forecast_area:toMega}</td><td align="right">{total_riverflood_forecast_area:toMega}</td></tr>',
                                            '<tr><td colspan="3"><div class="lineCustom4Table"></div></td></tr>',
