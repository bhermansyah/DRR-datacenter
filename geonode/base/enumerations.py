...
ORG_ACCRONYM = (
    ...
    ('EDU-JHU','EDU-JHU'),
    ('EDU-KPU','EDU-KPU'),
    ('EDU-KU-AFG','EDU-KU-AFG'),
    ('EDU-KU-US','EDU-KU-US'),
    ('EDU-LSE','EDU-LSE'),
    ('EDU-MTU','EDU-MTU'),
    ('EDU-PORT','EDU-PORT'),
    ('EDU-PRINCETON','EDU-PRINCETON'),
    ('EDU-READING','EDU-READING'),
    ('EDU-RITSUMEI','EDU-RITSUMEI'),
    ('EDU-SOTON','EDU-SOTON'),
    ('EDU-STANFORD','EDU-STANFORD'),
    ('EDU-UBALKH','EDU-UBALKH'),
    ('EDU-UBAMIYAN','EDU-UBAMIYAN'),
    ('EDU-UCHICAGO','EDU-UCHICAGO'),
    ('EDU-UCL','EDU-UCL'),
    ('EDU-UCSC','EDU-UCSC'),
    ('EDU-UNC','EDU-UNC'),
    ('EDU-UNIGE','EDU-UNIGE'),
    ('EDU-UNI-NKE','EDU-UNI-NKE'),
    ('EDU-UNI-STUTTGART','EDU-UNI-STUTTGART'),
    ('EDU-UOK','EDU-UOK'),
    ('EDU-VIU','EDU-VIU'),
    ('EDU-WM','EDU-WM'),
    ('EiEWG','EiEWG'),
    ('EMB-Canada','EMB-Canada'),
    ('EMB-Indonesia','EMB-Indonesia'),
    ('EMB-Norway','EMB-Norway'),
    ('ENEA','ENEA'),
    ('engageSPARK','engageSPARK'),
    ('EU Delegation','EU Delegation'),
    ('Euroports','Euroports'),
    ('EVIM','EVIM'),
    ('EWS','EWS'),
    ('FAO','FAO'),
    ...
    ('KabulMunicipality','KabulMunicipality'),
    ('KFW','KFW'),
    ...
    ('MoE','MoE'),
    ('MoEC','MoEC'),
    ('MoEC-Balkh','MoEC-Balkh'),
    ('MoF','MoF'),
    ('MoIC-Bamiyan','MoIC-Bamiyan'),
    ('MoM','MoM'),
    ('MONDIAL','MONDIAL'),
    ('MoPH','MoPH'),
    ('MoPW','MoPW'),
    ...
    ('NATO','NATO'),
    ('NEPA','NEPA'),
    ('NordicGeospatial','NordicGeospatial'),
    ('Novel-T','Novel-T'),
    ('NPO/RRAA','NPO/RRAA'),
    ('NPORRAA','NPORRAA'),
    ('NRC','NRC'),
    ...
    ('SIM','SIM'),
    ('SMDMHA','SMDMHA'),
    ('StandbyTaskForce','StandbyTaskForce'),
    ('STATE','STATE'),
    ('TDH','TDH'),
    ('TeacherTraining','TeacherTraining'),
    ('Terranodo','Terranodo'),
    ('Terrasense','Terrasense'),
    ('TetraTech','TetraTech'),
    ('UKSB','UKSB'),
    ('UNDP','UNDP'),
    ('UNEP','UNEP'),
...
ORG_NAME_STATUS = (
    ('OCHA (implies, exist in OCHA list)', 'OCHA (implies, exist in OCHA list)'),
    ('Non-OCHA (implies, does not exisit in OCHA list - yet was verified)', 'Non-OCHA (implies, does not exisit in OCHA list - yet was verified)'),
