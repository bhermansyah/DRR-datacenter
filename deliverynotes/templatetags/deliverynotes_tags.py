...
class BaseDeliveryNotesNode(template.Node):
...
class CommentCountNode(BaseDeliveryNotesNode):
...
class CommentsNode(BaseDeliveryNotesNode):
...
class CommentFormNode(BaseDeliveryNotesNode):
    ...
    def render(self, context):
        ...
        form_class = context.get("form", DeliveryNotesForm)
        form = form_class(obj=obj, user=user)
        context[self.varname] = form
        return ""


class CommentTargetNode(BaseDeliveryNotesNode):
