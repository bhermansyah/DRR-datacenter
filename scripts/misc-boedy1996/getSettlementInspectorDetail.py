...
try:
	...
	for row in reader:
		if first:
			...
			context_dict['high_flood_risk_area']=round((temp.get('271 cm', 0) or 0)/1000000,1)
			context_dict['med_flood_risk_area']=round((temp.get('121 cm', 0) or 0)/1000000,1)
			context_dict['low_flood_risk_area']=round((temp.get('029 cm', 0) or 0)/1000000,1)
			...
			context_dict['water_body_pop_flood_risk']=round(temp.get('Water body and Marshland', 0) or 0,0)
			context_dict['barren_land_pop_flood_risk']=round(temp.get('Barren land', 0) or 0,0)
			context_dict['built_up_pop_flood_risk']=round(temp.get('Build Up', 0) or 0,0)
			context_dict['fruit_trees_pop_flood_risk']=round(temp.get('Fruit Trees', 0) or 0,0)
			context_dict['irrigated_agricultural_land_pop_flood_risk']=round(temp.get('Irrigated Agricultural Land', 0) or 0,0)
			context_dict['permanent_snow_pop_flood_risk']=round(temp.get('Snow', 0) or 0,0)
			context_dict['rainfed_agricultural_land_pop_flood_risk']=round(temp.get('Rainfed', 0) or 0,0)
			context_dict['rangeland_pop_flood_risk']=round(temp.get('Rangeland', 0) or 0,0)
			context_dict['sandcover_pop_flood_risk']=round(temp.get('Sand Covered Areas', 0) or 0,0)
			context_dict['vineyards_pop_flood_risk']=round(temp.get('Vineyards', 0) or 0,0)
			context_dict['forest_pop_flood_risk']=round(temp.get('Forest & Shrub', 0) or 0,0)
			context_dict['sand_dunes_pop_flood_risk']=round(temp.get('Sand Dunes', 0) or 0,0)
			temp = dict([(c['agg_simplified_description'], c['area']) for c in floodRiskLC])
			context_dict['water_body_area_flood_risk']=round((temp.get('Water body and Marshland', 0) or 0)/1000000,1)
			context_dict['barren_land_area_flood_risk']=round((temp.get('Barren land', 0) or 0)/1000000,1)
			context_dict['built_up_area_flood_risk']=round((temp.get('Build Up', 0) or 0)/1000000,1)
			context_dict['fruit_trees_area_flood_risk']=round((temp.get('Fruit Trees', 0) or 0)/1000000,1)
			context_dict['irrigated_agricultural_land_area_flood_risk']=round((temp.get('Irrigated Agricultural Land', 0) or 0)/1000000,1)
			context_dict['permanent_snow_area_flood_risk']=round((temp.get('Snow', 0) or 0)/1000000,1)
			context_dict['rainfed_agricultural_land_area_flood_risk']=round((temp.get('Rainfed', 0) or 0)/1000000,1)
			context_dict['rangeland_area_flood_risk']=round((temp.get('Rangeland', 0) or 0)/1000000,1)
			context_dict['sandcover_area_flood_risk']=round((temp.get('Sand Covered Areas', 0) or 0)/1000000,1)
			context_dict['vineyards_area_flood_risk']=round((temp.get('Vineyards', 0) or 0)/1000000,1)
			context_dict['forest_area_flood_risk']=round((temp.get('Forest & Shrub', 0) or 0)/1000000,1)
			context_dict['sand_dunes_area_flood_risk']=round((temp.get('Sand Dunes', 0) or 0),0)
