...
if len(sys.argv) > 1 and sys.argv[1] == 'makecsv-districts':
    ...
    print 'optiions are: makecsv-districts, makecsv-provinces, makecsv-drawarea, makepdf-districts <papersize> <dpi>, makepdf-provinces <papersize> <dpi>, makepdf-drawarea <papersize> <dpi>'
