...
def getAccessibility(filterLock, flag, code): 
    ...
    data1.append(['',response['pop_on_gsm_coverage']])
    data1.append(['',response['Population']-response['pop_on_gsm_coverage']])
    response['total_pop_coverage_chart'] = gchart.PieChart(SimpleDataSource(data=data1), html_id="pie_chart1", options={'title':'', 'width': 135,'height': 135, 'pieSliceText': 'number', 'pieSliceTextStyle': 'black','legend': 'none', 'pieHole': 0.75, 'slices':{0:{'color':'red'},1:{'color':'grey'}}, 'pieStartAngle': 270, 'tooltip': { 'trigger': 'none' }, })

    data2 = []
    data2.append(['agg_simplified_description','area_population'])
    data2.append(['',response['area_on_gsm_coverage']])
    data2.append(['',response['Area']-response['area_on_gsm_coverage']])
    response['total_area_coverage_chart'] = gchart.PieChart(SimpleDataSource(data=data2), html_id="pie_chart2", options={'title':'', 'width': 135,'height': 135, 'pieSliceText': 'number', 'pieSliceTextStyle': 'black','legend': 'none', 'pieHole': 0.75, 'slices':{0:{'color':'red'},1:{'color':'grey'}}, 'pieStartAngle': 270, 'tooltip': { 'trigger': 'none' }, })

    dataNearestAirp = []
    dataNearestAirp.append(['time','population'])
    dataNearestAirp.append(['< 1',response['l1_h__near_airp'] if 'l1_h__near_airp' in response else 0])
    dataNearestAirp.append(['< 2',response['l2_h__near_airp'] if 'l2_h__near_airp' in response else 0])
    dataNearestAirp.append(['< 3',response['l3_h__near_airp'] if 'l3_h__near_airp' in response else 0])
    dataNearestAirp.append(['< 4',response['l4_h__near_airp'] if 'l4_h__near_airp' in response else 0])
    dataNearestAirp.append(['< 5',response['l5_h__near_airp'] if 'l5_h__near_airp' in response else 0])
    dataNearestAirp.append(['< 6',response['l6_h__near_airp'] if 'l6_h__near_airp' in response else 0])
    dataNearestAirp.append(['< 7',response['l7_h__near_airp'] if 'l7_h__near_airp' in response else 0])
    dataNearestAirp.append(['< 8',response['l8_h__near_airp'] if 'l8_h__near_airp' in response else 0])
    dataNearestAirp.append(['> 8',response['g8_h__near_airp'] if 'g8_h__near_airp' in response else 0])
    ...
    datatier1.append(['< 1',response['l1_h__near_hlt1'] if 'l1_h__near_hlt1' in response else 0])
    datatier1.append(['< 2',response['l2_h__near_hlt1'] if 'l2_h__near_hlt1' in response else 0])
    datatier1.append(['< 3',response['l3_h__near_hlt1'] if 'l3_h__near_hlt1' in response else 0])
    datatier1.append(['< 4',response['l4_h__near_hlt1'] if 'l4_h__near_hlt1' in response else 0])
    datatier1.append(['< 5',response['l5_h__near_hlt1'] if 'l5_h__near_hlt1' in response else 0])
    datatier1.append(['< 6',response['l6_h__near_hlt1'] if 'l6_h__near_hlt1' in response else 0])
    datatier1.append(['< 7',response['l7_h__near_hlt1'] if 'l7_h__near_hlt1' in response else 0])
    datatier1.append(['< 8',response['l8_h__near_hlt1'] if 'l8_h__near_hlt1' in response else 0])
    datatier1.append(['> 8',response['g8_h__near_hlt1'] if 'g8_h__near_hlt1' in response else 0])
    ...
    datatier2.append(['< 1',response['l1_h__near_hlt2'] if 'l1_h__near_hlt2' in response else 0])
    datatier2.append(['< 2',response['l2_h__near_hlt2'] if 'l2_h__near_hlt2' in response else 0])
    datatier2.append(['< 3',response['l3_h__near_hlt2'] if 'l3_h__near_hlt2' in response else 0])
    datatier2.append(['< 4',response['l4_h__near_hlt2'] if 'l4_h__near_hlt2' in response else 0])
    datatier2.append(['< 5',response['l5_h__near_hlt2'] if 'l5_h__near_hlt2' in response else 0])
    datatier2.append(['< 6',response['l6_h__near_hlt2'] if 'l6_h__near_hlt2' in response else 0])
    datatier2.append(['< 7',response['l7_h__near_hlt2'] if 'l7_h__near_hlt2' in response else 0])
    datatier2.append(['< 8',response['l8_h__near_hlt2'] if 'l8_h__near_hlt2' in response else 0])
    datatier2.append(['> 8',response['g8_h__near_hlt2'] if 'g8_h__near_hlt2' in response else 0])
    ...
    datatier3.append(['< 1',response['l1_h__near_hlt3'] if 'l1_h__near_hlt3' in response else 0])
    datatier3.append(['< 2',response['l2_h__near_hlt3'] if 'l2_h__near_hlt3' in response else 0])
    datatier3.append(['< 3',response['l3_h__near_hlt3'] if 'l3_h__near_hlt3' in response else 0])
    datatier3.append(['< 4',response['l4_h__near_hlt3'] if 'l4_h__near_hlt3' in response else 0])
    datatier3.append(['< 5',response['l5_h__near_hlt3'] if 'l5_h__near_hlt3' in response else 0])
    datatier3.append(['< 6',response['l6_h__near_hlt3'] if 'l6_h__near_hlt3' in response else 0])
    datatier3.append(['< 7',response['l7_h__near_hlt3'] if 'l7_h__near_hlt3' in response else 0])
    datatier3.append(['< 8',response['l8_h__near_hlt3'] if 'l8_h__near_hlt3' in response else 0])
    datatier3.append(['> 8',response['g8_h__near_hlt3'] if 'g8_h__near_hlt3' in response else 0])
    ...
    datatierall.append(['< 1',response['l1_h__near_hltall'] if 'l1_h__near_hltall' in response else 0])
    datatierall.append(['< 2',response['l2_h__near_hltall'] if 'l2_h__near_hltall' in response else 0])
    datatierall.append(['< 3',response['l3_h__near_hltall'] if 'l3_h__near_hltall' in response else 0])
    datatierall.append(['< 4',response['l4_h__near_hltall'] if 'l4_h__near_hltall' in response else 0])
    datatierall.append(['< 5',response['l5_h__near_hltall'] if 'l5_h__near_hltall' in response else 0])
    datatierall.append(['< 6',response['l6_h__near_hltall'] if 'l6_h__near_hltall' in response else 0])
    datatierall.append(['< 7',response['l7_h__near_hltall'] if 'l7_h__near_hltall' in response else 0])
    datatierall.append(['< 8',response['l8_h__near_hltall'] if 'l8_h__near_hltall' in response else 0])
    datatierall.append(['> 8',response['g8_h__near_hltall'] if 'g8_h__near_hltall' in response else 0])
    ...
    datatitsx_prov.append(['< 1',response['l1_h__itsx_prov'] if 'l1_h__itsx_prov' in response else 0])
    datatitsx_prov.append(['< 2',response['l2_h__itsx_prov'] if 'l2_h__itsx_prov' in response else 0])
    datatitsx_prov.append(['< 3',response['l3_h__itsx_prov'] if 'l3_h__itsx_prov' in response else 0])
    datatitsx_prov.append(['< 4',response['l4_h__itsx_prov'] if 'l4_h__itsx_prov' in response else 0])
    datatitsx_prov.append(['< 5',response['l5_h__itsx_prov'] if 'l5_h__itsx_prov' in response else 0])
    datatitsx_prov.append(['< 6',response['l6_h__itsx_prov'] if 'l6_h__itsx_prov' in response else 0])
    datatitsx_prov.append(['< 7',response['l7_h__itsx_prov'] if 'l7_h__itsx_prov' in response else 0])
    datatitsx_prov.append(['< 8',response['l8_h__itsx_prov'] if 'l8_h__itsx_prov' in response else 0])
    datatitsx_prov.append(['> 8',response['g8_h__itsx_prov'] if 'g8_h__itsx_prov' in response else 0])
    ...
    datatnear_prov.append(['< 1',response['l1_h__near_prov'] if 'l1_h__near_prov' in response else 0])
    datatnear_prov.append(['< 2',response['l2_h__near_prov'] if 'l2_h__near_prov' in response else 0])
    datatnear_prov.append(['< 3',response['l3_h__near_prov'] if 'l3_h__near_prov' in response else 0])
    datatnear_prov.append(['< 4',response['l4_h__near_prov'] if 'l4_h__near_prov' in response else 0])
    datatnear_prov.append(['< 5',response['l5_h__near_prov'] if 'l5_h__near_prov' in response else 0])
    datatnear_prov.append(['< 6',response['l6_h__near_prov'] if 'l6_h__near_prov' in response else 0])
    datatnear_prov.append(['< 7',response['l7_h__near_prov'] if 'l7_h__near_prov' in response else 0])
    datatnear_prov.append(['< 8',response['l8_h__near_prov'] if 'l8_h__near_prov' in response else 0])
    datatnear_prov.append(['> 8',response['g8_h__near_prov'] if 'g8_h__near_prov' in response else 0])
    ...
    datatnear_dist.append(['< 1',response['l1_h__near_dist'] if 'l1_h__near_dist' in response else 0])
    datatnear_dist.append(['< 2',response['l2_h__near_dist'] if 'l2_h__near_dist' in response else 0])
    datatnear_dist.append(['< 3',response['l3_h__near_dist'] if 'l3_h__near_dist' in response else 0])
    datatnear_dist.append(['< 4',response['l4_h__near_dist'] if 'l4_h__near_dist' in response else 0])
    datatnear_dist.append(['< 5',response['l5_h__near_dist'] if 'l5_h__near_dist' in response else 0])
    datatnear_dist.append(['< 6',response['l6_h__near_dist'] if 'l6_h__near_dist' in response else 0])
    datatnear_dist.append(['< 7',response['l7_h__near_dist'] if 'l7_h__near_dist' in response else 0])
    datatnear_dist.append(['< 8',response['l8_h__near_dist'] if 'l8_h__near_dist' in response else 0])
    datatnear_dist.append(['> 8',response['g8_h__near_dist'] if 'g8_h__near_dist' in response else 0])
